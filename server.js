...
app.post('/api/posts', cpUpload, async (req, res) => {
  try {
    ...
    const q = `INSERT INTO posts (title, author, content_blocks) VALUES ($1, $2, $3) RETURNING id, title, author, content_blocks AS "contentBlocks", comments, created_at AS "createdAt", updated_at AS "updatedAt"`;
